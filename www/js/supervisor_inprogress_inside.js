...
//alert(oneemp);
  $('.sddq').append('<li><a href="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneemp');
//$('.document_imag_inprooneqc').append('<img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+one+'"><img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
//$('.document_imag_inprooneqd').append('<img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'"><img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');

}
if (j == 2 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqb').append('<img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 3 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqa').append('<img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 4 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqe').append('<img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 5 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqf').append('<img src="http://staging.eimpressive.com/insurance-changes/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
